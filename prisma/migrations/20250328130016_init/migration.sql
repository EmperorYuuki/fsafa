...
CREATE TABLE "ReadingProgress" (
    ...
    "storyId" TEXT NOT NULL,
    "chapterId" TEXT,
    "lastParagraphRead" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "TagsOnStories" (
    ...
    CONSTRAINT "TagsOnStories_pkey" PRIMARY KEY ("storyId","tagId")
);
...
-- AddForeignKey
ALTER TABLE "TagsOnStories" ADD CONSTRAINT "TagsOnStories_storyId_fkey" FOREIGN KEY ("storyId") REFERENCES "Story"("id") ON DELETE CASCADE ON UPDATE CASCADE;
